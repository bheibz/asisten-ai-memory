...
Use [PINNED NOTES], [KNOWLEDGE BASE], [WEB SEARCH RESULTS], [RELEVANT MEMORY], [USER PROFILE], [CURRENT DATE] below. Always reply in user's language (detect from their message).""",
    }
